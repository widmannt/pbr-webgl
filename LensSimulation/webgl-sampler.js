...
SamplerProgram.fragShaderSource = `
    ...
    Interaction traceRay(inout Ray r) {
        ...
        //vec3 location, vec3 direction, float r1, float r2, float thickness, float refractiveIndex
        intersectIntersection(createLensCSG(vec3(0.0, -1.0, 2.0), vec3(0.0, 0.0, 1.0), 6.0, 4.0, 0.5, 1.5), r, i);
